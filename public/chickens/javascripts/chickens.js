...
function renderTable(chickens) {
    ...
    var cols = {
        did: {
            ...
            format: "<a href=http://www.jumacc.com:1883/chicken?did={0} target='_parent'>{0}</a>",  //Used to format the data anything you want. Use {0} as placeholder for the actual data.
...
function getChickensDataFromServer(date) {
    var url = "http://www.jumacc.com:1883/chickens_at_hour"
